    ...
    render() {
        ...
        <footer>
            <div class="social-media">
                <a href="https://www.linkedin.com/in/betim-cakiqi-60919b217/" target="_blank" rel="noopener noreferrer"><img class="social-media-icons"
                        src="./assets/icons/social-media-icons/linkedin-icon.svg" alt="LinkedIn"></a>
                <a href="https://www.instagram.com/betimcakiqii/" target="_blank" rel="noopener noreferrer"><img class="social-media-icons"
                        src="./assets/icons/social-media-icons/instagram-icon.svg" alt="Instagram"></a>
                <a href="https://www.facebook.com/betimcakiqii/" target="_blank" rel="noopener noreferrer"><img class="social-media-icons"
                        src="./assets/icons/social-media-icons/facebook-icon.svg" alt="Facebook"></a>
                <a href="https://x.com/betiimc" target="_blank" rel="noopener noreferrer"><img class="social-media-icons"
